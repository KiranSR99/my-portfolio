    ...
    <app-section id="experience" number="02" heading="Where I've Worked">
      <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1 py-1">
          <div *ngIf="jobs[activeTabIndex] as job" class="animate-fade-in">
            ...
            <ul class="space-y-4">
              <li *ngFor="let duty of job.duties" class="flex gap-3 text-description leading-relaxed">
                <lucide-icon [img]="check" class="w-4 h-4 mt-1 text-primary shrink-0 opacity-70"></lucide-icon>
                <span>{{ duty }}</span>
              </li>
            </ul>
          </div>
